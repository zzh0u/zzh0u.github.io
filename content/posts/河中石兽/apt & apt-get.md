+++
title = 'apt & apt Get'
date = 2024-08-27T10:16:32+08:00
lastmod = 2024-08-27T10:16:32+08:00
draft = false
author = ["zzh0u"]
tags = ["技术","terminal","Linux 命令"]
description = "" # 文章描述，与搜索优化相关
summary = "之前用 Ubuntu 做实验的时候，总要提前安装很多包，然后就会用到包管理工具。继而就会了解到有 apt 和 apt-get 两个命令，出与知其所以然（水一篇博客）的想法，我去搜了一下他们的区别。" 
showToc = true # 显示目录
TocOpen = true # 自动展开目录
